...
// internally by the stem weight ROM controller. The activation window interface
// remains external for now and can later be connected to an activation
// controller/buffer wrapper at this same level.

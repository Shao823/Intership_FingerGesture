...
//
// The output side is a registered valid/ready stage. If the downstream output
// is not ready, s3 holds and back-pressures the window response channel.
// Top-level stream slices provide cross-module elasticity.
...
module dw_conv2_4ch_5tap #(
    ...
    parameter BIAS_INIT_FILE     = {`PROJECT_ROOT, "/weight_data/dw2/bias_int32.mem"},
    parameter MULT_INIT_FILE     = {`PROJECT_ROOT, "/weight_data/dw2/multiplier_q15.mem"},
    parameter SHIFT_INIT_FILE    = {`PROJECT_ROOT, "/weight_data/dw2/right_shift.mem"}
) (
    input  wire clk,
    input  wire rst_n,

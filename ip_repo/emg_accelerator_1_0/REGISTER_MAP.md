...
| 1 | AUTO_START | R/W | Automatically start whenever a complete frame is ready. |
| 2 | CLEAR_DONE | W1P | Clear the sticky DONE status. |
| 3 | CLEAR_ERRORS | W1P | Clear receive and rejected-start error flags. |
| 4 | IRQ_ENABLE | R/W | Enable `irq` for sticky DONE. |

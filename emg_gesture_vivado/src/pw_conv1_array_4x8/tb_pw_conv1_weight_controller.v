...
module tb_pw_conv1_weight_controller #(
    ...
    initial begin
        $readmemh({`PROJECT_ROOT, "/weight_data/pw1/weight_packed.mem"}, rom_mem);
    end
    ...
    task run_sequence;
        ...
        begin
            ...
            $display(
                "INFO L%0d %0s requests=%0d responses=%0d cycles=%0d req_stalls=%0d req_gaps=%0d first_gap=%0d unique_addrs=%0d",
                BRAM_READ_LATENCY,
                label,
                total_requests,
                total_responses,
    ...
    initial begin
        ...
        if (errors == 0) begin
            $display("PASS tb_pw_conv1_weight_controller");
        end else begin
            $display("FAIL tb_pw_conv1_weight_controller errors=%0d", errors);
            $finish;
        end
        $finish;
    end

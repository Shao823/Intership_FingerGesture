...
//
// ROM layout: 679 x 128-bit, 16 signed INT8 lanes per word.
//   FC0: addr = (oc_base / 16) * 97 + k
//        oc_base = 0,16,...,80; k=0..95 weight, k=96 reserved zero padding
//   FC1: addr = 582 + k
//        k=0..95 weight, k=96 reserved zero padding; lanes 0..4 valid.
// Biases and requantization parameters are separate local memories in the
// compute core.
